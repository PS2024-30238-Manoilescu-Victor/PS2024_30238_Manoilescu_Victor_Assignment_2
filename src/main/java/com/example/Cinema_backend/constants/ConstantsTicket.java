...
public class ConstantsTicket {
    ...
    public static String nonexistentSale(Long id){return "The ticket with id \"" + id + "\" has no promotion.";}
    ...
    public static String wrongPercentage(){return "Percentage has to be between 0 and 100.";}
